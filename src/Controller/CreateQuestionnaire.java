...
public class CreateQuestionnaire extends HttpServlet {
    private static Hashtable<Integer, User> questionnairesTable = new Hashtable<Integer, User>();
    // JDBC 驱动名及数据库 URL
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        questionnairesTable.put(questionnairesTable.size(), new User(request.getParameter("Questionnaire subject")));
        ...
        try (PrintWriter out = response.getWriter()) {             /* TODO output your page here. You may use following sample code. */
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> Questionnaire cr茅e " + questionnairesTable.get(questionnairesTable.size() - 1).toString() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    ...
    private void insererData() {
        ...
        Statement stmt = null;
        User user = questionnairesTable.get(questionnairesTable.size() - 1);
        ...
        try{
            ...
            String sql;
            sql = "INSERT INTO User (subject) VALUES ('"+ questionnaire.getSubject()+"')";
